...
import { Sparkles, Clock, ChevronDown, ChevronUp, Calculator, Percent, ExternalLink } from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        <DialogHeader className="shrink-0">
          <DialogTitle className="flex items-center gap-2 text-xl font-headline"><Sparkles className="h-5 w-5 text-accent" /> Quick Quote Results</DialogTitle>
        ...
        <div className="flex-grow overflow-y-auto py-4 space-y-6">
          <div className="border rounded-md overflow-hidden bg-card">
            {results.length > 0 ? (
                ...
                <div className="p-8 text-center text-muted-foreground italic flex flex-col items-center gap-2 font-headline">
