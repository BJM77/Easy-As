...
export default function FreightForm() {
  ...
  const runCalculation = async (data: FreightFormValues) => {
    ...
    try {
      ...
      const sorted = [...results].sort((a, b) => (a.finalPrice ?? Infinity) - (b.finalPrice ?? Infinity));
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div className="space-y-1">
          <h1 className="text-2xl md:text-3xl font-bold font-headline tracking-tight">Freight Calculator</h1>
